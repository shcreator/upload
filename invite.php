...
?>
	...
	<?php if (REFERRAL_COMMISSION > 0) { ?>
     ...
     ?>
     		<br>
     		<p class="pull-right"><i class="fa fa-money fa-lg"></i> <b>Your Earnings</b>: <span class="label label-success"><b>$0.00</b></span></p>
			...
			<?php while ($row = mysqli_fetch_array($result)) { $cc++; ?>
                <tr class="<?php if (($cc%2) == 0) echo "row_even"; else echo "row_odd"; ?>">
                  ...
                  <td valign="middle" align="left" style="padding-left: 30px"><span style="font-size: 18px; color: #5bbc2e"><b>$<?php echo CalculatePercentage(($row['exchange_amount']/20), REFERRAL_COMMISSION); ?></b></span></td>
